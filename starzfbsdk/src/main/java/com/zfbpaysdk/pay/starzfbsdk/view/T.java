package com.zfbpaysdk.pay.starzfbsdk.view;
...
public class T {
    ...
    public static void showTextToast(Context activity, String msg) {
        if (toast == null) {
...
//            toast.setGravity(Gravity.CENTER, 0, 0);
    ...
    public static void showTextCenterToast(Context activity, String msg) {
        if (toast == null) {
            toast = Toast.makeText(activity, msg, toastDuration);
            toast.setGravity(Gravity.CENTER, 0, 0);
        } else {
